      ...
      <div className='flex gap-2 mb-6 mt-3'>
        {
          ...
          <>
            <label className='flex items-center' htmlFor="resumeUpload">
              <p className='bg-orange-100 text-orange-600 px-4 py-2 rounded-lg mr-2'>{resume ? resume.name : "Select Resume "}</p>
          ...
          <div className='flex gap-2'>
            {userData && userData.resume ? (
              <a target='_blank' href={userData.resume} className = "bg-orange-100 text-orange-600 px-4 py-2 rounded-lg" >Resume</a>
            ):(
