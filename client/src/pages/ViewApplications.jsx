                  ...
                  <tr key={index} className="text-gray-700">
                    ...
                    <td className="py-2 px-4 border-b">
                      <a
                        ...
                        target="_blank"
                        className="bg-orange-50 text-orange-400 px-3 py-1 rounded inline-flex gap-2 items-center"
                      >
                        ...
                        >
                          ...
                          <div className="z-10 hidden absolute right-0 md:left-0 top-0 mt-2 w-32 bg-white border border-gray-200 rounded shadow group-hover:block">
                            <button onClick={()=>changeJobApplicationStatus(applicant._id,'Accepted')}
                              ...
                              className="block w-full text-left px-4 py-2 text-orange-500 hover:bg-gray-100"
                            >
                              Accept
                            </button>
